...
function Main(props){
    ...
    <div className="main">
        <div className="left">  
            ...
            <div id="success" className="success">Emails sent successfully</div>
            <div id="error" className="error">Invalid Email</div>
            ...
            <div class="textarea">
                <textarea class="bodytext" name="bio" rows="10" cols="75" required placeholder="    Body Paragraph..."></textarea>
            </div>
            <div class="sendButton">
                <button class="main_btn"><h2>SEND</h2></button>
            </div>
        </div>
    </div>
    );
